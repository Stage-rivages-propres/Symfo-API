...
class AdminDashboardController extends AbstractDashboardController
{
    ...
    public function configureMenuItems(): iterable
    {
        ...
        yield MenuItem::section('Démarche');
        yield MenuItem::linkToCrud('Démarche qualité', 'fas fa-list', DemarcheBase::class);
        yield MenuItem::linkToCrud('Paragraphe démarche', 'fas fa-list', Parademarche::class);
        yield MenuItem::section('Equipe');
        yield MenuItem::linkToCrud('Equipe', 'fas fa-list', Membres::class);
